  ...
  return (
    <section id="about" className="about-me-section">
      ...
      <div className="hero-content">
        <h1 className="hero-title">Hello, I'm Saurabh Rai</h1>
        ...
        <p className="hero-description">
          ...
          dynamic web applications and software solutions.
        </p>
      ...
      <div className="about-me-container">
        ...
        <div className="about-me-content">
          <p>
            I am Saurabh Rai, a dedicated and passionate software engineer with
            a strong background in computer science and engineering. I hold a
            Master's degree in Computer Science from the New Jersey Institute of
            Technology and a Bachelor's degree in Information Technology from
            the University of Mumbai.
          </p>
          <p>
            My technical expertise spans various domains, including Java,
            ReactJs, HTMl, CSS, AWS, SQL, Docker, and Linux. Throughout my
            professional journey, I have gained valuable experience in
            developing scalable and efficient software solutions.
          </p>
          <p>
            I thrive in challenging environments that push me to innovate and
            grow. My goal is to leverage my skills and knowledge to develop
